...
| [`conversation-activity-panel.tsx`](../src/features/agents/conversation-activity-panel.tsx) | Separate horizontal glass chips and bounded Plan/Tools sections, opening at bottom content outside the transcript |
